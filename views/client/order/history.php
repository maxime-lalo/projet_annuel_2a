                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td rowspan="<?= $menu->getIngredientsNum() + $menu->getRecipesNum() ?>"><?= $menu->getPrice() * $menu->getQuantity(); ?> €</th>
                                    <?php
                                        } else {
                                    ?>
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        if (data.status == "success") {
                            ...
                            Swal.fire({
                                icon: 'success',
                                title: 'Annulation confirmé',
                                text: 'Votre commande a été annulé !',
                                footer: '<h6>Si vous avez déjà effectué un payement, il vous sera rembourser sous 24h</h6>'
                            })
                        }
